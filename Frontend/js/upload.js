    ...
    uploadForm.addEventListener('submit', (e) => {
        ...
        async function saveAndRedirect() {
            try {
                ...
                formData.append("file", audioFile); // MUST match Flask
                ...
                if (data.transcript) {
                    ...
                    // Temporary local storage (until backend DB is ready)
                    const newSession = {
                    ...
                    const history = JSON.parse(localStorage.getItem('echopilot_history')) || [];
                    history.unshift(newSession);
                    localStorage.setItem('echopilot_history', JSON.stringify(history));
